...
@Component({
  ...
  templateUrl: './tupper.component.html',
  styleUrls: ['./tupper.component.scss'],
})
export class TupperComponent implements OnInit {
  public data: any;
  public results: any;
  product: any;
  img: any;
  ...
  async goPrint() {
    ...
    this.api.previewTupperCong(this.product, formattedExpirationDate, formattedDefrostDate).then((result: any) => {
      this.product = null;
    }).catch((err: any) => {
      // Handle error
    });
  ...
  async generatePreview() {
    ...
    this.img = await this.api.previewTupperCong(this.product, formattedExpirationDate, formattedDefrostDate);
